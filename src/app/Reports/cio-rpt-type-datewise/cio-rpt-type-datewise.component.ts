...
@Component({
  selector: 'app-cio-rpt-type-datewise',
  templateUrl: './cio-rpt-type-datewise.component.html',
  styleUrls: ['./cio-rpt-type-datewise.component.scss']
})
export class CioRptTypeDatewiseComponent implements OnInit{
  ...
  Types:any = [{title:'All'},{title:'Check In'},{title:'Check Out'}, ]
